...
BEGIN
    UPDATE Pub_Article SET ArticleTitle=d.ArticleTitle,ArticleCategory=d.ArticleCategory,ContentText=d.ContentText,ArticleTag=d.ArticleTag,ArticleDesc=d.ArticleDesc,AidStyle=d.AidStyle,UpdateTime=d.UpdateTime FROM Pub_Article a INNER JOIN Pri_ArticleDraft d ON a.ArticleKey=d.ArticleKey WHERE a.ArticleKey=@ArticleKey;
END ELSE BEGIN
    INSERT INTO Pub_Article( ArticleKey ,ArticleTitle ,ArticleCategory ,ContentText ,ArticleTag ,ArticleDesc,AidStyle ,UpdateTime )
    SELECT TOP 1 ArticleKey ,ArticleTitle ,ArticleCategory ,ContentText ,ArticleTag ,ArticleDesc,AidStyle ,UpdateTime  FROM Pri_ArticleDraft WHERE ArticleKey=@ArticleKey;
END" : "DELETE FROM Pub_Article WHERE ArticleKey=@ArticleKey "; //如果取消发布，直接逻辑删除该发布的记录
        ...
        {
            string sql = "select  Id , ArticleKey,ArticleTitle,ArticleCategory,ContentText,ArticleTag,ArticleDesc,AidStyle,UpdateTime from Pub_Article where ArticleKey=@ArticleKey";
        ...
        {
            string sql = "select  Id , ArticleKey,ArticleTitle,ArticleCategory,ContentText,ArticleTag,ArticleDesc,AidStyle,UpdateTime from Pub_Article ORDER BY " + orderby;
